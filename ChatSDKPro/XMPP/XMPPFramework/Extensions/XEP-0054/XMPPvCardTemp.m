...
- (NSArray *)addresses {
    ...
    NSArray *elements = [self elementsForName:@"ADR"];
    for (NSXMLElement *element in elements) {
        XMPPvCardTempAdr *item = [XMPPvCardTempAdr vCardAdrFromElement:element];
...
- (void)clearAddresses {
    [self removeElementsForName:@"ADR"];
}

- (NSArray *)labels {
    NSMutableArray *result = [NSMutableArray new];
    NSArray *elements = [self elementsForName:@"LABEL"];
    for (NSXMLElement *element in elements) {
        XMPPvCardTempLabel *item = [XMPPvCardTempLabel vCardLabelFromElement:element];
        [result addObject:item];
    }
    return result;
}
...
- (void)setLabels:(NSArray *)labels {
    [self clearLabels];
    for (XMPPvCardTempLabel *lab in labels) {
        [self addLabel:lab];
    }
}
- (void)clearLabels {
    [self removeElementsForName:@"LABEL"];
}

- (NSArray *)telecomsAddresses {
    NSMutableArray *result = [NSMutableArray new];
    NSArray *elements = [self elementsForName:@"TEL"];
    for (NSXMLElement *element in elements) {
        XMPPvCardTempTel *item = [XMPPvCardTempTel vCardTelFromElement:element];
        [result addObject:item];
    }
    return result;
}
