...
#ifndef CHATSDKVENDOR_SWIFT_H
#define CHATSDKVENDOR_SWIFT_H
...
#import <ChatSDKVendor/ChatSDKVendor.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChatSDKVendor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP13ChatSDKVendor21XMPPBookmarksDelegate_")
...
@interface GCDMulticastDelegate (SWIFT_EXTENSION(ChatSDKVendor)) <XMPPBookmarksDelegate>
@end



typedef SWIFT_ENUM(NSInteger, XMPPBookmarksMode, open) {
...
SWIFT_CLASS("_TtC13ChatSDKVendor19XMPPBookmarksModule")
...
@interface XMPPBookmarksModule (SWIFT_EXTENSION(ChatSDKVendor)) <XMPPStreamDelegate>
...
@interface XMPPPresence (SWIFT_EXTENSION(ChatSDKVendor))
/// ‘urn:xmpp:idle:1’
