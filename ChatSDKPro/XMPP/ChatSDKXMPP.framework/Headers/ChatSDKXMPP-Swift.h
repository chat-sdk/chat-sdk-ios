...
SWIFT_CLASS("_TtC11ChatSDKXMPP13SilentMessage")
@interface SilentMessage : NSObject
- (XMPPMessage * _Nonnull)get:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (void)trigger:(XMPPMessage * _Nonnull)message from:(NSString * _Nonnull)from;
- (BOOL)matches:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
+ (void)ignoreWithMessageId:(NSString * _Nullable)messageId;
+ (BOOL)shouldIgnoreWithMessageId:(NSString * _Nullable)messageId SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ChatSDKXMPP16JoinGroupMessage")
@interface JoinGroupMessage : SilentMessage
- (XMPPMessage * _Nonnull)get:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (void)trigger:(XMPPMessage * _Nonnull)message from:(NSString * _Nonnull)from;
- (BOOL)matches:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
@interface LeaveGroupMessage : SilentMessage
- (nonnull instancetype)initWithUser:(XMPPJID * _Nullable)user OBJC_DESIGNATED_INITIALIZER;
- (XMPPMessage * _Nonnull)get:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (void)trigger:(XMPPMessage * _Nonnull)message from:(NSString * _Nonnull)from;
- (BOOL)matches:(XMPPMessage * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
@interface RXPromise (SWIFT_EXTENSION(ChatSDKXMPP))
+ (RXPromise * _Nonnull)streamNotLive SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)hasLeft:(BOOL)value userEntityID:(NSString * _Nonnull)userEntityID;
- (NSString * _Nullable)userJIDWithRoomJID:(XMPPJID * _Nonnull)roomJID SWIFT_WARN_UNUSED_RESULT;
@end
...
- (NSDictionary<NSString *, id> * _Nonnull)getMeta SWIFT_WARN_UNUSED_RESULT;
- (XMLElement * _Nullable)getExtras SWIFT_WARN_UNUSED_RESULT;
- (int32_t)getType SWIFT_WARN_UNUSED_RESULT;
- (int32_t)getAction SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)markMessageRead:(id <PMessage> _Null_unspecified)message;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
