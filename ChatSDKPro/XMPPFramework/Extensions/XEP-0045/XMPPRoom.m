...
//- (void)handleFetchVisitorsListResponse:(XMPPIQ *)iq withInfo:(id <XMPPTrackingInfo>)info
//{
//    if ([[iq type] isEqualToString:@"result"])
//    {
//        // <iq type='result'
...
//        NSArray *items = [query elementsForName:@"item"];
//        
//        [multicastDelegate xmppRoom:self didFetchVisitorsList:items];
//    }
//    else
//    {
//        [multicastDelegate xmppRoom:self didNotFetchVisitorsList:iq];
//    }
//}
...
//        [self->responseTracker addID:fetchID
//                       target:self
//                     selector:@selector(handleFetchVisitorsListResponse:withInfo:)
//                      timeout:60.0];
//
//    }};
//
...
+(NSXMLElement *)itemWithRole:(NSString *)role nick:(NSString *) nick
{
    NSXMLElement *item = [NSXMLElement elementWithName:@"item"];
    ...
    if (nick)
        [item addAttributeWithName:@"nick" stringValue:nick];
