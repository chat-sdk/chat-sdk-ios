Pod::Spec.new do |s|
  ...
  s.subspec 'CoreData' do |cd|
    ...
    cd.source_files = ['CoreData/Classes/**/*']
  ...
  s.subspec 'UI' do |ui|
    ...
    ui.source_files = ['UI/Classes/**/*']
    ui.resource_bundles = {
      'ChatUI' => ['UI/Assets/**/*', 'UI/Interface/**/*']
    }
  ...
  s.subspec 'FirebaseAdapter' do |fi| 
	...
	fi.source_files = ['FirebaseAdapter/Classes/**/*']
